...
- Use the `/pmfkit.` command prefix to easily discover Spec Kit-related commands.
...
- All command files now prefixed with `pmfkit.` (e.g., `pmfkit.specify.md`, `pmfkit.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
