...
- All command files now prefixed with `pmfkit.` (e.g., `pmfkit.pmf.md`, `pmfkit.plan.md`) for better discoverability and differentiation in IDE/CLI command palettes and file explorers
